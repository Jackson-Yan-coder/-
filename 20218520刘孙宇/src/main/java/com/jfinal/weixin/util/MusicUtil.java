...
public class MusicUtil {
    public String searchMusic(String search,int page) throws UnsupportedEncodingException {
        String search_url="https://www.kuwo.cn/search/searchMusicBykeyWord?vipver=1&client=kt&ft=music&cluster=0&strategy=2012&encoding=utf8&rformat=json&mobi=1&issubtitle=1&show_copyright_off=1&pn="+page+"" +
            "&rn=20&all="+ URLEncoder.encode(search,"UTF-8");
    ...
    public String getMp3Url(String mid){
        String search_url="http://www.xintuo1.cn/kw/"+mid;
       return HttpKit.get(search_url);
