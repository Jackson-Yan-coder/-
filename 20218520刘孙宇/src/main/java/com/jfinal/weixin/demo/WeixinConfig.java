...
//        ApiConfigKit.setAccessTokenCache(new RedisAccessTokenCache("weixin"));
        ...
        ac.setEncodingAesKey(PropKit.get("encodingAesKey", "XD2yP93IFJAENZLufHoWDFBmeWjZVcRXRuTa1AJuark"));
...
//        }
        ...
        wc.setAppId("wx60bf5645b5df1549");
        wc.setAppSecret("6cf692abf8facc17f5d7c6ce28e7e3a1");
