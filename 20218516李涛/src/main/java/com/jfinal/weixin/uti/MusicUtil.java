...
public class MusicUtil {
    public String searchMusic(String search,int page) throws UnsupportedEncodingException {
        String search_url="https://www.kuwo.cn/search/searchMusicBykeyWord?vipver=1&client=kt&ft=music&cluster=0&strategy=2012&encoding=utf8&rformat=json&show_copyright_off=1&pn="+page+"&rn=20&all="+ URLEncoder.encode(search,"UTF-8");        String s=HttpKit.get(search_url);
        String value="";
