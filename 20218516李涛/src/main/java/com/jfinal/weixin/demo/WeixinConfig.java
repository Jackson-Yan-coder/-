...
import com.jfinal.weixin.Controller.DianYingCotroller;
...
public class WeixinConfig extends JFinalConfig {
    ...
    public void configRoute(Routes me) {
        ...
        me.add("/dy", DianYingCotroller.class);
...
//        ApiConfigKit.setAccessTokenCache(new RedisAccessTokenCache("weixin"));
        ...
        ac.setEncodingAesKey(PropKit.get("encodingAesKey", "mWxcMLIHXdovXBFdF4GHrrQ4ZLtaAlYHxOG1A8Ad71J"));
...
//        }
        ...
        wc.setAppId("wx7750653dc6fc092e");
        wc.setAppSecret("3e261e0ed21e93f82005ec57c496b891");
