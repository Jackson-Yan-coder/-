...
import com.jfinal.weixin.controller.DianYingController;
import com.jfinal.weixin.demo.util.DianYingUtil;
...
public class WeixinConfig extends JFinalConfig {
    ...
    public void configRoute(Routes me) {
        ...
        me.add("/dy", DianYingController.class);
...
//        ApiConfigKit.setAccessTokenCache(new RedisAccessTokenCache("weixin"));
        ...
        ac.setEncodingAesKey(PropKit.get("encodingAesKey", "VFOJ9vIChsvUGZOyDmIXu6hjqjMJvb63dR0FZcqVn1o"));
...
//        }
        ...
        wc.setAppId("wxb51f3289be77a17f");
        wc.setAppSecret("9bf4840439e01a565d42a0b15db870b3");
