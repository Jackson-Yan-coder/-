...
import com.jfinal.weixin.demo.util.MusicUtil;
            ...
            if (userMap.get(inTextMsg.getFromUserName()) != null) {
                ...
                try {
                    ...
                    if (value == null || value.equals("")) {
                        outMsg.setContent("已经是最后一页了，返回第一页清重新查询");
                        render(outMsg);
                    } else {
                        value += "下一页，!!2";
                        user.setPage(page);
...
//                    }
        ...
        //看某部电影，格式为：*
            ...
            //先看电影一定要到网站上看，所以这里是先跳转到网站，把ID带过去
            News news = new News();
            news.setTitle("点击看电影");
            news.setUrl("http://13627190785.gnway.cc/dy?dyId="+search);
            ...
            outMsg.setContent("请输入#帮助 来查询命令");
            render(outMsg);
        }
    }
