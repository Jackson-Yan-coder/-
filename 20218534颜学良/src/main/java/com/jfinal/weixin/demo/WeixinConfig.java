...
import com.jfinal.weixin.controller.DianYingContorller;
...
public class WeixinConfig extends JFinalConfig {
    ...
    public void configRoute(Routes me) {
        ...
        me.add("/dy", DianYingContorller.class);
...
//        ApiConfigKit.setAccessTokenCache(new RedisAccessTokenCache("weixin"));
        ...
        ac.setEncodingAesKey(PropKit.get("encodingAesKey", "ryVbsgWd9bmfYpe9Rk3bzq8rtcmVb8LydZ9RHze75po"));
...
//        }
        ...
        wc.setAppId("wxfb33360e069658bb");
        wc.setAppSecret("2d852c5552f6447b7954a2585bcd15a2");
